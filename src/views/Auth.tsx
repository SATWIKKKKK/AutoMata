    ...
    <div className="bg-background text-on-surface antialiased min-h-screen relative flex items-center justify-center selection:bg-primary selection:text-on-primary font-body-md text-body-md overflow-x-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="font-technical-mono text-technical-mono text-on-surface-variant uppercase tracking-widest text-[10px]">
            Or
          </span>
          <div className="h-[1px] bg-outline-variant flex-1 opacity-30"></div>
        </div>
      ...
      <main className="flex-grow flex items-center justify-center p-8 relative z-10 w-full overflow-y-auto pt-24 pb-48">
        ...
        >
          ...
          <div className="mb-12 text-center">
            ...
            <h1 className="font-display-xl text-display-xl text-primary mt-2">
              Reset Password.
            </h1>
          ...
          >
            ...
            <div className="relative">
              <label
                className="block font-technical-mono text-technical-mono text-on-surface-variant uppercase tracking-wider mb-2 text-[10px]"
                htmlFor="reset-email"
              >
                Email Address
              </label>
            ...
            <div className="pt-4">
              <button
                className="w-full bg-black text-white font-ui-label text-ui-label py-4 rounded-full hover:bg-neutral-800 shadow-xl hover:shadow-2xl transition-all duration-200 flex items-center justify-center gap-2 active:scale-95"
                type="submit"
              >
      ...
      <main className="flex-grow flex items-center justify-center p-8 relative z-10 w-full overflow-y-auto pt-24 pb-48">
        ...
        >
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              <div className="flex justify-between items-center mb-2">
                <label
                  className="block font-technical-mono text-technical-mono text-on-surface-variant uppercase tracking-wider text-[10px]"
                  htmlFor="password"
                >
                  Password
                </label>
                <button
                  ...
                  className="font-technical-mono text-technical-mono text-secondary hover:text-primary transition-colors underline decoration-outline-variant underline-offset-4 text-[10px]"
                >
                  Forgot?
                </button>
              </div>
          ...
          <div className="mt-10 flex items-center gap-4">
            ...
            <span className="font-technical-mono text-technical-mono text-on-surface-variant text-[10px] tracking-widest">
              OR CONTINUE WITH
            </span>
            <div className="h-[1px] flex-1 bg-surface-variant opacity-30"></div>
          </div>
