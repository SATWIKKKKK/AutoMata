...
export const CronTriggerNode = memo(({ data }: any) => (
  <div className="bg-surface-container-lowest border border-blueprint-line rounded-xl shadow-lg w-64 overflow-hidden group hover:border-blueprint-accent transition-colors">
    <NodeHeader 
      icon={<Clock size={16} />} 
  ...
  <div className="bg-surface-container-lowest border border-blueprint-line rounded-xl shadow-lg w-64 overflow-hidden group hover:border-blueprint-accent transition-colors">
    ...
    <div className="p-4 space-y-2">
      <div className="flex gap-2">
        <span className="px-2 py-1 rounded bg-blueprint-line/40 text-technical-mono text-[10px]">GEMINI-3</span>
      </div>
...
export const ConditionNode = memo(({ data }: any) => (
  <div className="bg-surface-container-lowest border-2 border-blueprint-line rounded-xl p-6 w-48 shadow-lg hover:border-blueprint-accent transition-colors">
    <div className="flex flex-col items-center gap-4">
       ...
       <div className="text-center">
         ...
         <p className="text-technical-mono text-blueprint-muted normal-case text-[10px] mt-1">If output contains "error"</p>
       </div>
    </div>
    <Handle type="target" position={Position.Top} />
